    ...
    <div className="p-8 h-full overflow-y-auto bg-slate-900 text-slate-200">
      <div className="max-w-4xl mx-auto">
        <div className="flex items-center space-x-3 mb-8">
          ...
          <h1 className="text-3xl font-bold text-slate-100">About This App</h1>
        </div>

        <div className="space-y-6 text-slate-300 bg-slate-800/50 p-6 rounded-lg border border-slate-700">
          ...
          <div className="flex items-center justify-center pt-6 border-t border-slate-700/50">
            <Map size={20} className="text-cyan-400 mr-3 flex-shrink-0" />
            <p className="text-slate-400">
              Ready to explore? Click on the <strong className="font-semibold text-cyan-300">Map</strong> tab to begin your analysis.
            </p>
          </div>
        </div>
      </div>
