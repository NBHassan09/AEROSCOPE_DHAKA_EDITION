...
const schoolAnalysisData = [
  { name: 'Tejgaon Air Base', value: 290, color: 'bg-blue-600' },
  { name: 'Mirpur Cantonment', value: 558, color: 'bg-blue-600' },
  { name: 'HSIA', value: 456, color: 'bg-blue-600' },
];

const hospitalAnalysisData = [
  { name: 'Tejgaon Air Base', value: 18, color: 'bg-pink-600' },
  { name: 'Mirpur Cantonment', value: 29, color: 'bg-pink-600' },
  { name: 'HSIA', value: 22, color: 'bg-pink-600' },
];
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mt-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="bg-gray-800/50 p-5 rounded-lg border border-gray-700"><div className="flex items-center mb-3"><HeartPulse size={22} className="mr-3 text-pink-500" /><h4 className="font-bold text-lg">Healthcare Accessibility</h4></div><p className="text-gray-400 text-sm">A similar pattern emerges for healthcare. <strong className="text-gray-200">Mirpur Cantonment (29 hospitals)</strong> again leads in medical facility concentration. The lower numbers around <strong className="text-gray-200">HSIA (22)</strong> and especially <strong className="text-gray-200">Tejgaon (18)</strong> may indicate reliance on centralized military or specialized facilities over numerous smaller clinics.</p></div>
